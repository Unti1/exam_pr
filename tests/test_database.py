...
class TestDatabaseManager:
    ...
    def test_get_book_by_id(self):
        ...
        book = Book("Преступление и наказание", "Федор Достоевский", "978-5-389-12346-7", 1866, 3)
        book_id = self.db_manager.add_book(book)
    ...
    def test_update_book(self):
        ...
        # Обновляем книгу
        self.db_manager.update_book(book_id, title="Новое название", author="Новый автор")
    ...
    def test_update_reader(self):
        ...
        # Обновляем читателя
        self.db_manager.update_reader(reader_id, name="Новое имя", email="new@example.com")
    ...
    def test_delete_reader(self):
        ...
        reader = Reader("Читатель для удаления", "delete@example.com", "+7-999-123-45-67")
        reader_id = self.db_manager.add_reader(reader)
