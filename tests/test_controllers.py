...
class TestBookController:
    ...
    def test_update_book(self):
        ...
        # Обновляем книгу
        self.controller.update_book(book_id, title="Новое название", author="Новый автор")
    ...
    def test_delete_book(self):
        """Тест удаления книги"""
        book_id = self.controller.add_book("Книга для удаления", "Автор", "123-789", 2020, 1)
...
class TestReaderController:
    ...
    def test_get_all_readers(self):
        ...
        self.controller.add_reader("Читатель 1", "reader1@example.com", "+7-999-111-11-11")
        self.controller.add_reader("Читатель 2", "reader2@example.com", "+7-999-222-22-22")
    ...
    def test_update_reader(self):
        ...
        # Обновляем читателя
        self.controller.update_reader(reader_id, name="Новое имя", email="new@example.com")
...
class TestLoanController:
    ...
    def test_create_loan(self):
        ...
        reader_id = self.reader_controller.add_reader("Читатель", "reader@example.com", "+7-999-123-45-67")
        
        loan_date = datetime.now()
        return_date = loan_date + timedelta(days=14)
        
        loan_id = self.controller.create_loan(book_id, reader_id, loan_date, return_date)
