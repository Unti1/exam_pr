...
## Дополнительные задания (для отличников)

1. Добавить систему уведомлений о просроченных книгах
2. Реализовать экспорт данных в Excel/CSV
3. Добавить систему резервного копирования базы данных
4. Реализовать поиск с автодополнением
5. Добавить графики статистики (количество выдач, популярные книги) 